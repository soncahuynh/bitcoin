...
### Marscoin maintainers/release engineers, suggestion for writing release notes
...
### Build and sign Marscoin Core for Linux, Windows, and OS X:
...
- Update bitcoin.org version
  ...
  - First, check to see if the Marscoin.org maintainers have prepared a
  ...
  - If they have not prepared a release, follow the Marscoin.org release
...
- Announce the release:
  ...
  - Marscoin Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - bitcoincore.org blog post

  - Update title of #bitcoin on Freenode IRC

  - Optionally twitter, reddit /r/Marscoin, ... but this will usually sort out itself
