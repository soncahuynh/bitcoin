Download URL: https://sourceforge.net/projects/bitcoin/files/Marscoin/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MARSC fee schedule (users still pay 0.01 MARSC per kb, until next version)
