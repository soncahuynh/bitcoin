Marscoin Core version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer MARSC/kB fee to be
...
Block pruning allows Marscoin Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Marscoin Core will 
...
- #6116 `30dc3c1` [OSX] rename Marscoin-Qt.app to Marscoin-Core.app
