Marscoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Marscoin/bitcoin-0.5.4/
...
Fix Marscoin-Qt notifications under Growl 1.3.
Increase required age of Marscoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Marscoin-Qt over it. (Windows)
