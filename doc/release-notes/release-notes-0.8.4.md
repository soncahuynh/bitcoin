Marscoin-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Marscoin/bitcoin-0.8.4/
...
code, causing the Marscoin-Qt or bitcoind process to crash.
...
their own version of Marscoin against Boost versions 1.50-1.52.
