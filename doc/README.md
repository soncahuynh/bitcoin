...
Drag Marscoin-Core to your applications folder, and then run Marscoin-Core.

### Need Help?

* See the documentation at the [Marscoin Wiki](https://en.bitcoin.it/wiki/Main_Page)
...
* Discuss general Marscoin development on #bitcoin-dev on Freenode. If you don't have an IRC client use [webchat here](http://webchat.freenode.net/?channels=bitcoin-dev).
