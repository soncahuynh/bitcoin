#!/usr/bin/env python3
# Copyright (c) 2017 The Marscoin Core developers
...
class ListSinceBlockTest (BitcoinTestFramework):
    ...
    def test_double_spend(self):
        ...
        1. User 1 receives MARSC in tx1 from utxo1 in block aa1.
        2. User 2 receives MARSC in tx2 from utxo1 (same) in block bb1
