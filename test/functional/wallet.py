...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 MARSC from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 MARSC with subtract fee from amount
        ...
        # Sendmany 10 MARSC with subtract fee from amount
